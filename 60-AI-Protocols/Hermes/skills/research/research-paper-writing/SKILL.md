...
metadata:
  hermes:
    ...
    triggers:
      ...
      - "write an ML paper"
      - "write a NeurIPS/ICML/ICLR/ACL/AAAI/COLM paper"
      - "design experiments for a paper"
      - "prepare paper submission"
      - "respond to paper reviews"
      - "convert paper to another conference format"
      - "write a non-empirical paper (theory, survey, benchmark, position)"
      - "design human evaluation for NLP/HCI/alignment paper"
      - "prepare poster/talk for accepted paper"
