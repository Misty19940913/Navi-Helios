...
triggers:
  - "我要做 RLHF / Post-Training"
  - "要用 SFT 做 instruction fine-tuning"
  - "要用 DPO 做 preference alignment"
  - "要用 PPO 或 GRPO 做 reinforcement learning"
  - "要訓練 reward model"
  - "要對模型做 human feedback alignment"
  - context: "當需要對 LLM 做 post-training 對齊工作時觸發"
    examples:
      - "我想讓模型回答更有幫助"
      - "我要訓練一個獎勵模型"
      - "DPO 和 PPO 有什麼差別"
