...
| 可视化 / visualization | `bento-grid` | `craft-handmade`, `corporate-memphis` | landscape | — |
| 信息可视化 / data-viz | `bento-grid` | `corporate-memphis`, `technical-schematic` | landscape | — |
| 视觉摘要 / visual-summary | `bento-grid` | `craft-handmade` | landscape | — |
| 信息图表 | `bento-grid` | `craft-handmade` | landscape | — |
