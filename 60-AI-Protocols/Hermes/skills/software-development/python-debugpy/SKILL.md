...
metadata:
  hermes:
    ...
    trigger: "When the user asks to debug a Python process, set a breakpoint, inspect a running process, debug a test, or investigate a crash/exception in Python code"
---
