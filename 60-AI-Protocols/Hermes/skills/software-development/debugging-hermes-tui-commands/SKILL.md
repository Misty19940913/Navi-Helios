...
license: MIT
triggers:
  - "slash command not working in TUI"
  - "TUI autocomplete missing command"
  - "hermes tui command debug"
  - "command exists in CLI but not TUI"
  - "slash command inconsistent between CLI and TUI"
  - "command persists config but UI not updating"
  - "/command not found in autocomplete"
  - "gateway slash command not dispatching"
  - "TUI command autocomplete broken"
  - "hermes tui slash debug"
