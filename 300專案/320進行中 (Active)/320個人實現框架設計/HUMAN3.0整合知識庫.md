...
## 摘要
這是一套在生活所有領域最大限度地發揮潛力的指導方針。透過剖析使用者的經歷並針對現實重新規劃，目的是為了盡可能在未來過上更好的生活。Navi 模型展現了宏觀圖景，它是一套指導方針，而非教條式的步驟。它以歷史上發現的模式為導向，並以各種已完成研究的科學、心理、精神 and 職業發展模型為基礎，幫助使用者發揮潛能，突破瓶頸。

## PART 0: 核心背景

### 為何這很重要：[[元危機 (The Metacrisis)]]
在深入個人發展前，必須理解我們所處的文明時刻——「元危機」，這不是單一危機，而是所有全球危機相互交織的網絡，由三大生成函數驅動：
1.  [[競爭性動態(Rivalrous Dynamics)(Rivalrous Dynamics)]] (Rivalrous Dynamics)：一方的成功建立在另一方失敗上的雙輸遊戲。
2.  [[基質消耗（Substrate Depletion]] (Substrate Consumption)：複雜系統消耗其生存基礎的速度，遠超其再生速度（如自然資源、社會信任）。
3.  [[指數級技術 (Exponential Technology)]] (Exponential Technology)：技術（特別是AI）的發展速度超越了人類的智慧與制度的適應能力。

---

## PART I: HUMAN 3.0 模型架構

### 一、[[H3.0-四大象限|四大象限]]
代表生命的四個基本領域，必須平行發展。
- **心智 (Mind)**：你如何理解現實。
- **身體 (Body)**：你如何體現潛力。
- **精神 (Spirit)**：你如何連結並創造意義。
- **職業 (Vocation)**：你如何創造價值與影響力。

### 二、[[H3.0-三大層級|三大層級]]
每個象限內的意識發展階段。
- **等級 1.0 - 墨守成規者 (The Conformist)**：依賴外部權威。
- **等級 2.0 - 個人主義者 (The Individualist)**：追求個人目標。
- **等級 3.0 - 綜合者 (The Synthesist)**：整合多重觀點，創造規則。

### 三、[[H3.0-階段系統|三個階段]]
深刻的轉變通常經歷：**不和諧** -> **不確定性** -> **發現**。

### 四、[[HUMAN 3.0 特質系統|特質系統 (The Trait System)]]
為了向前發展，必須平衡：**知識 (Knowledge)**、**經驗 (Experience)**、**技能 (Skill)**。

---

## PART II: 進階動態 (Advanced Dynamics)

### 五、[[發展通道 (Channels)|通道 (Channels)]]
在「不和諧」階段可觸發的加速發展時期，特徵是產生痴迷般的學習或建構慾望。

### 六、[[Glitches (發展加速器)|Glitches (高風險發展加速器)]]
強行進入通道或突破瓶頸的策略。
- **[[AI 元加速器 (AI Meta-Glitch)]]**：最強大的元加速器，能同時影響所有四個象限，但若基礎不穩會放大弱點。

### 七、[[H3.0-跨象限效應]]
各象限之間相互影響。
- **[[跨象限解鎖與阻礙]]**：理解一個象限的瓶頸如何由另一象限造成，以及如何透過特定序列解鎖潛力。

### 八、[[虛假轉變 (False Transformation)]]
僅採用更高發展等級的表面外觀，而沒有根本的意識轉變。

### 九、[[前-超誤判 (Pre-Trans Fallacy)]]
將「前理性」的狀態（L1）誤認為是「超理性」的狀態（L3）。在 H3.0 中，這通常表現為跳過 L2 的訓練而宣稱達到 L3。

### 十、[[H3.0-退行機制]]
在壓力下回到早期的發展模式，是一種自然的保護機制。

---

## PART III: 原型與應用

### 十一、[[生活方式等級 (Lifestyle Levels)]]
描述四個象限在日常生活中如何整合：
- **1.0 偶然型 (Accidental)**：生活發生在你身上。
- **2.0 設計型 (Designed)**：生活由你發生（強行平衡）。
- **3.0 整合型 (Integrated)**：生活透過你發生（自然支持）。

### 十二、[[生活方式原型 (Lifestyle Archetypes)]]
常見的不平衡發展模式：工作狂、尋道者、優化者、漂泊者、專家、整合者。

### 十三、[[H3.0-複合型態]]
象限原型的綜合體，如：高管、武僧、教授、企業家。

### 十四、應用案例：[[H3.0-金錢三大等級]]
展示「職業」象限從生存、成功到神聖的演變路徑。

---

## PART IV: 實踐與評估

### 十五、[[HUMAN 3.0 問題解決方法論|問題解決方法論]]
透過識別根源象限、設計最小有效劑量方案、追尋通道來進化。

### 十六、自我評估框架與 AI 提示
（以下內容為完整的 HUMAN 3.0 自我評估提示，可用於 AI 深度訪談）
...
- [[基礎-工具能力差 (The Foundation-Tool Gap)]]
