...
const BlueTime: React.FC = () => {
  ...
  const rotatorStyle: React.CSSProperties = {
    position: 'absolute',
    left: `${BLUE_TIME_LAYOUT.center.x}px`,
    top: `${BLUE_TIME_LAYOUT.center.y}px`,
    width: '183px',
    height: '183px',
    transformOrigin: `${BLUE_TIME_LAYOUT.pivot.x}px ${BLUE_TIME_LAYOUT.pivot.y}px`,
    pointerEvents: 'none',
  };
  ...
  return (
    <div style={{ 
      ...
      {/* Background */}
      <img src={`${assetBase}/TimeBG.png`} alt="" style={{ position: 'absolute', left: 0, top: 0 }} />
