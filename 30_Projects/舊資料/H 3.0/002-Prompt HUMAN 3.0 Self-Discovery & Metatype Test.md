...
time_modifie: 2026-01-31
related: null
parent: null
source: https://letters.thedankoe.com/p/prompt-human-30-self-discovery-and
author:
- '[[DAN KOE]]'
type: content
folder: area
...
如果你還沒讀過 HUMAN 3.0 的詳細拆解，你可以看[[001-HUMAN 3.0 – A Map To Reach The Top 1%|這篇]]：
In short, this prompt helps map where your development lies in each quadrant and gives you a plan to reach the next level.
簡而言之，這個指令（Prompt）能幫你描繪出你在生活各個象限的發展階段，並為你制定晉升下一階的計畫。
...
這可能需要一些調整與迭代才能趨於完美，但我認為第一個版本已經非常出色，能揭示你未曾察覺的視角。
...
厭倦了那種「修補了一個地方，生活其他部分卻崩潰」的自我成長嗎？
...
這不是另一個把你框架住的性格測試。**HUMAN 3.0 評估**會精確繪製你在「心智、身體、精神、天職」四大領域的**實際**發展程度，找出你卡住的真相，並給出對策。
Through an adaptive interview that adjusts to your responses, this system:
透過能根據你的回答自動調整的「適應性訪談」，本系統將：
...
**核心重點**：花 20 分鐘，你會比過去幾年攝取的自我成長資訊更了解自己的現狀。
...
我建議使用具備「推理能力」的模型，例如 **Claude 3.5/4.1 (開啟 Extended Thinking)** 或 **ChatGPT-4o/o1**。
This prompt is very long since it needs all details about HUMAN 3.0.
Copy, paste, and chat with it for 20 minutes or so.
這個指令非常長，因為它包含了 HUMAN 3.0 的所有細節。複製、貼上，並與它對話約 20 分鐘。
